...
export default {
  ...
  theme: {
    extend: {
      backgroundImage: {
        "complex-radial": `radial-gradient(circle at 29% 55%, hsla(329,0%,99%,0.05) 0%, hsla(329,0%,99%,0.05) 4%,transparent 4%, transparent 44%,transparent 44%, transparent 100%),
          ...
          linear-gradient(45deg, rgb(101,114,75),rgb(89,125,32))`,
      },
      colors: {
