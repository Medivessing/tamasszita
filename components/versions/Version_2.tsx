...
const Version_2 = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center lg:p-8 lg:pt-0 justify-center gap-6 lg:gap-24 scrollbar-hide">
      <div className="card rounded-2xl max-w-[400px] p-4 lg:p-10 flex flex-col items-center lg:mb-auto mt-40 ">
      ...
      <div className="flex flex-col lg:mt-16 ">
        <div className="card rounded-2xl mx-auto lg:mx-0 lg:ml-auto p-5 items-center flex flex-row justify-between gap-5 mb-5">
          <button
