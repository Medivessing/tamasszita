...
const CV = () => {
  return (
    <div className="no-scrollbar scrollbar-hide">
      ...
      {/* <p className="text-4xl text-[#ffffff100] font-semibold">Önéletrajz</p> */}
      {/* <div className="h-[2px] w-full bg-gradient-to-r  from-[#556B2F] to-[#ABDB58]" /> */}
      {/* </div> */}

      <div className="items-center text-center ">
        <p className="text-2xl text-[#ffffff100] pb-3 font-semibold ">
          Tapasztalat
        </p>
        <div className="h-[2px] w-full bg-[#ffffff40] " />

        <div className="flex flex-col text-left pt-3">
          <div className="flex flex-col md:flex-row justify-between text-[#ffffff100]">
        ...
        <div className="items-center text-center ">
          <p className="text-2xl text-[#ffffff100] py-3 font-semibold ">
            Tanulmányok
          </p>
          <div className="h-[2px] w-full bg-[#ffffff40] " />
          <div className="flex flex-col text-left pt-3">
        ...
        <div className="items-center text-center ">
          ...
          <div className="flex flex-col md:flex-row justify-between py-3">
            <div className="flex flex-col text-left gap-2">
              <div className="flex flex-col text-[#ffffff100]">
